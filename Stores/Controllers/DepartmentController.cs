    ...
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var department = await _context.Departments
                .FirstOrDefaultAsync(m => m.DepartmentCode.ToString() == id);
            if (department == null)
            {
                return NotFound();
            }
        ...
        {
            if (id != department.DepartmentCode.ToString())
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DepartmentExists(department.DepartmentCode.ToString()))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Departments.Any(e => e.DepartmentCode.ToString() == id);
        }
    }
}
